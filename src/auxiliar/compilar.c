...
// argc (argument count): quantidade de parâmetros digitados ao chamar o
// programa. argv (argument vector): vetor contendo os textos passados no
// terminal. Exemplo de uso: ./compilar bhaskara.c (argc = 2, argv[1] =
// "bhaskara.c")
int main(int argc, char *argv[]) {
  char comando[256];

  // Verifica se o usuário informou exatamente 1 parâmetro extra (o nome do
  // arquivo .c).
  if (argc != 2) {
